/*
complexDriver.cpp : This is used to test the code
*/
#include <iostream> 
#include "stdafx.h"
#include "complex.h"
...
int main()
{
	...
	Complex c1, c2(1.2, 4.9), c3(2.2, 1.0), c4(-7.0, 9.6), c5(8.1, -4.3), c6(0.0, -7.1), c7(6.4), c8(0.0, 1.0), c9(0.0, 4.1), c10(0.0, -1.0), c11;															//This c7(6.4) is there for the constructor
